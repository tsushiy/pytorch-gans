...
def get_options():
  ...
  parser.add_argument("--num_epochs", type=int, default=100, help="# of training epochs without decaying lr")
  parser.add_argument("--num_epochs_decay", type=int, default=100, help="# of training epochs with decaying lr")
  parser.add_argument("--save_epoch_freq", type=int, default=10, help="how often to save models")
  parser.add_argument("--visualize_iter_freq", type=int, default=6, help="how often to visualize images")
